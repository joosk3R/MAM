...
class RealignedCT(Dataset):
    def __init__(self, transform, mode='train'):
        ...
        self.score_dir = os.path.abspath("./metal_annotations")
    ...
    def __getitem__(self, idx):
        ...
        if flag == 'upper':
            img_name = 'crop_upper_img' + '_'+ person_id + ' - Seg완료.nii.gz'
            box_anno = 'upper_bbox.json'
            TOOTH_NUM = UPPER_TOOTH_NUM
        elif flag == 'lower':
            img_name = 'crop_lower_img' + '_'+person_id + ' - Seg완료.nii.gz'
...
def get_detection_dataloader(test_transform):
